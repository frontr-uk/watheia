import LinkOut from '../../base-ui.icons/link-out';

export const CtaSection = () => (
  <div className="relative bg-gray-900">
    <div className="relative h-56 bg-accent sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
      <img
        ...
        <div className="mt-8">
          <div className="inline-flex rounded-md shadow">
            ...
            >
              ...
              <LinkOut className="-mr-1 ml-3 h-5 w-5 text-gray-400" aria-hidden="true" />
            </a>
          </div>
        </div>
      </div>
