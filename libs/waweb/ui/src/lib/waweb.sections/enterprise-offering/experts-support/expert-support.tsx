...
export const ExpertSupport = (props: HTMLAttributes<HTMLDivElement>) => (
  <div
    ...
    data-bit-id="waweb.sections/enterprise-offering/experts-support"
  >
      ...
      <div className={classNames(styles['mainContent'], marginCenter)}>
        ...
        <Card className={styles['card']}>
          ...
          <Paragraph className={mutedText} size={PossibleSizes.sm}>
            Guarantee fast response times and availability through personal support channels to
            ensure your team never slows down delivery.
          </Paragraph>
        </Card>
        <Card className={styles['card']}>
          <Paragraph
          ...
          <Paragraph className={mutedText} size={PossibleSizes.sm}>
            Enjoy personal support from dedicated experts that you can reach anytime you need.
            And, add multiple escalation paths to your arsenal just in case.
          </Paragraph>
        </Card>
        <Card className={styles['card']}>
          <Paragraph
