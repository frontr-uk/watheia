 ...
 */
export function InlineCode({ children, highlight, className, ...rest }: InlineCodeProps) {
  return (
    <code
      {...rest}
      className={classNames(styles['inlineCode'], highlight && styles['highlight'], className)}
    >
      {children}
    </code>
  );
