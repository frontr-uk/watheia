  ...
  return (
    <Grid colMd={2} className={classNames(styles['particlesBg'], styles['grid'])}>
      ...
      <Card id="contact-support" className={classNames(colorPalette.process, styles['card'])}>
        ...
        <Paragraph size={PossibleSizes.sm} className={styles['subtitle']}>
          Enjoy personalized support from core Bit experts and engineers, that will make sure
          your delivery is never slowed down.
        </Paragraph>

        <ul className={styles['bullets']}>
          <li>
            <Icon of="billing-checkmark" className={themedText} /> Dedicated, named Bit experts
          </li>
          <li>
      ...
      <Card id="contact-build" className={classNames(colorPalette.primary, styles['card'])}>
        ...
        <Paragraph size={PossibleSizes.sm} className={styles['subtitle']}>
          Get the resources and performance to build at global scale. Integrate Bit with your
          toolchain to boost delivery and time to market.
        </Paragraph>
