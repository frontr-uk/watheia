  ...
  return (
    ...
    >
      <div className={classNames(textColumn, marginCenter)}>
        ...
        >
          Forget about maintaining additional docs, websites, wikis, and tools. Bit makes sure
          every single component is documented, organized and discoverable at any scale.
        </Paragraph>
      </div>
