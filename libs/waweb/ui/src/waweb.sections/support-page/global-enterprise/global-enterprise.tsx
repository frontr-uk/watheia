...
export function GlobalEnterprise({ className, ...rest }: GlobalEnterpriseProps) {
  const cards = [
    ...
    },
    {
      ...
      text: 'We’ll design and provide the solutions to root Bit into your enterprise ecosystem.',
    ...
    >
      <div className={classNames(styles['topSection'], marginCenter, text.center)}>
        ...
        <Paragraph size={PossibleSizes.lg} className={styles['paragraph']}>
          Bit enterprise helps global teams to speed up and standardize modern web development.
          We’re here to help hands-on every step of the way.
        </Paragraph>
